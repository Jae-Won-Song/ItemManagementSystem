...
var _aro = require("./core/aro");
class App extends (0, _aro.Component) {
    render() {
...
},{"./core/aro":"ke37l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ke37l":[function(require,module,exports) {
// Component
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _itemAdd = require("../components/ItemAdd");
var _itemAddDefault = parcelHelpers.interopDefault(_itemAdd);
var _itemDel = require("../components/ItemDel");
var _itemDelDefault = parcelHelpers.interopDefault(_itemDel);
var _detail = require("../components/Detail");
var _detailDefault = parcelHelpers.interopDefault(_detail);
exports.default = (0, _aro.createRouter)([
    {
        path: "#/",
    ...
    {
        path: "#/add",
        component: (0, _itemAddDefault.default)
    },
    {
        path: "#/del",
        component: (0, _itemDelDefault.default)
    },
    {
        path: "#/detail",
        component: (0, _detailDefault.default)
    }
]);

},{"../core/aro":"ke37l","./Home":"0JSNG","../components/ItemAdd":"nTh47","../components/ItemDel":"5kvFl","../components/Detail":"jVaEL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"0JSNG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _aro = require("../core/aro");
var _headline = require("../components/Headline");
var _headlineDefault = parcelHelpers.interopDefault(_headline);
var _globalBar = require("../components/GlobalBar");
var _globalBarDefault = parcelHelpers.interopDefault(_globalBar);
var _tableCol = require("../components/TableCol");
var _tableColDefault = parcelHelpers.interopDefault(_tableCol);
class Home extends (0, _aro.Component) {
    render() {
        const headline = new (0, _headlineDefault.default)().el;
        const globalbar = new (0, _globalBarDefault.default)().el;
        const tablecol = new (0, _tableColDefault.default)();
        this.el.classList.add("container");
        this.el.append(headline, globalbar, tablecol.el);
    }
}
exports.default = Home;

},{"../core/aro":"ke37l","../components/Headline":"gaVgo","../components/GlobalBar":"7HBQm","../components/TableCol":"kjE86","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gaVgo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _aro = require("../core/aro");
class Headline extends (0, _aro.Component) {
    render() {
        this.el.classList.add("nav-top");
        this.el.innerHTML = /* html */ `
        <a href="/#/">\u{C7AC}\u{ACE0} \u{AD00}\u{B9AC} \u{C2DC}\u{C2A4}\u{D15C}</a>
        `;
        return this.el;
    }
}
...
},{"../core/aro":"ke37l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7HBQm":[function(require,module,exports) {
// GlobalBar.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _aro = require("../core/aro");
class GlobalBar extends (0, _aro.Component) {
    ...
    render() {
        ...
        this.el.innerHTML = /* html */ `
            <button class="add-btn"><a href="/#/add"> \u{BB3C}\u{D488} \u{CD94}\u{AC00} </a></button>
            <button class="del-btn"> <a href="/#/del"> \u{BB3C}\u{D488} \u{C81C}\u{AC70} </a></button>
            <input class="search" type="text" onkeyup="filter()" id="searchItem" placeholder='\u{CC3E}\u{ACE0} \u{C788}\u{B294} \u{BB3C}\u{D488}\u{C744} \u{C785}\u{B825}\u{D558}\u{C138}\u{C694}.'>
        `;
...
},{"../core/aro":"ke37l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kjE86":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _aro = require("../core/aro");
...
class TableCol extends (0, _aro.Component) {
    constructor(){
        super();
        this.data = []; // 사용자 입력을 저장할 배열
        this.database = (0, _database.getDatabase)(); // Firebase 데이터베이스 초기화
        this.updateTable();
    }
    render() {
    ...
    updateTable() {
        ...
        const dbRef = (0, _database.ref)(this.database, "items");
        (0, _database.onValue)(dbRef, (snapshot)=>{
            ...
            } else tableContainer.innerHTML = "<p>\uB370\uC774\uD130\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.</p>";
        });
    }
            ...
            headers.forEach((header)=>{
                ...
                if (header !== "index") {
                    ...
                    if (header === "\uC774\uBBF8\uC9C0") {
                        ...
                        td.appendChild(img);
                    } else td.textContent = rowData[header];
                    row.appendChild(td);
                }
            });
            // 번호를 표시하는 컬럼 추가
...
},{"../core/aro":"ke37l","firebase/app":"aM3Fo","firebase/database":"SJ4UY","../components/Detail":"jVaEL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aM3Fo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _app = require("@firebase/app");
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jVaEL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _aro = require("../core/aro");
var _database = require("firebase/database");
class Detail extends (0, _aro.Component) {
    constructor(){
        super();
        this.database = (0, _database.getDatabase)(); // Firebase 데이터베이스 초기화
        ...
        const dbRef = (0, _database.ref)(this.database, `items/${itemKey}`);
        (0, _database.onValue)(dbRef, (snapshot)=>{
    ...
    render() {
        ...
        this.el.innerHTML = /* html */ `
            <h2>${itemName}</h2>
            <p>\u{C218}\u{B7C9}: ${itemCount}</p>
            <p>\u{C720}\u{D1B5}\u{AE30}\u{D55C}: ${itemExpiration}</p>
            <p>\u{BC1C}\u{C8FC}\u{CC98}: ${itemSupplier}</p>
            <p>\u{C774}\u{BBF8}\u{C9C0}: <img src="${itemImage}" alt="\u{C774}\u{BBF8}\u{C9C0}"></p>
            <!-- \u{CD94}\u{AC00}\u{C801}\u{C778} \u{B370}\u{C774}\u{D130} \u{CD9C}\u{B825}\u{C744} \u{C6D0}\u{D558}\u{BA74} \u{C5EC}\u{AE30}\u{C5D0} \u{CD94}\u{AC00} -->
        `;
    }
}
exports.default = Detail;

},{"../core/aro":"ke37l","firebase/database":"SJ4UY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"nTh47":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _aro = require("../core/aro");
...
var _headlineDefault = parcelHelpers.interopDefault(_headline);
var _database = require("firebase/database");
class ItemAdd extends (0, _aro.Component) {
    constructor(){
        super();
        this.data = []; // 사용자 입력을 저장할 배열
        // Firebase 데이터베이스 초기화
        this.database = (0, _database.getDatabase)();
    }
    render() {
        const headlineComponent = new (0, _headlineDefault.default)();
                    ...
                    <section>
                        <div class="add-tb-content">
                            <div>
                                ...
                                <input type="text" id="name" placeholder="\u{D488}\u{BA85}">
                                <label for="company"></label>
                                <input type="text" id="company" placeholder="\u{BC1C}\u{C8FC}\u{CC98}">
                                <label for="count"></label>
                                <input type="number" id="count" placeholder="\u{C218}\u{B7C9}">
                                <label for="date"></label>
                                <input type="date" id="date">
                                <label for="img"></label>
                                <input type="file" accept=".img, .jpg, .png" class="add-img" id="img">
                                <button id="addRow">\u{CD94}\u{AC00}</button>
                            </div>
                        </div>
                    </section>
                `;
        ...
        this.el.querySelector("#addRow").addEventListener("click", ()=>{
            ...
            if (name && count && date && company && img) {
                ...
                reader.onload = (event)=>{
                    ...
                    const dbRef = (0, _database.ref)(self.database, "items");
                    (0, _database.push)(dbRef, newRow);
                    // 입력 필드 초기화
...
},{"../core/aro":"ke37l","./Headline":"gaVgo","firebase/database":"SJ4UY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5kvFl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _aro = require("../core/aro");
var _headline = require("./Headline");
...
const app = (0, _app.initializeApp)(firebaseConfig);
class ItemDel extends (0, _aro.Component) {
    constructor(){
        super();
        this.data = []; // 사용자 입력을 저장할 배열
        this.database = (0, _database.getDatabase)(); // Firebase 데이터베이스 초기화
    ...
    // Firebase에서 아이템 삭제
    deleteItem(itemKey) {
        const itemRef = (0, _database.ref)(this.database, `items/${itemKey}`);
...
exports.default = ItemDel;

},{"../core/aro":"ke37l","./Headline":"gaVgo","firebase/app":"aM3Fo","firebase/database":"SJ4UY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["anvqh","gLLPy"], "gLLPy", "parcelRequire18c9")
